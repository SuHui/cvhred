...
if __name__ == '__main__':
    ...
    parser.add_option("--run-mode", dest="mode", help="0 for train, 1 for test, 2 for test decode word", default=2)
    parser.add_option("--load-chkpt", dest="load_chkpt", help="Path to checkpoint file. Required for mode:1",
                      #default='')
                      default='./Checkpoints/-epoch37')
